...
public class ClientQuiverTooltip implements ClientTooltipComponent {
    ...
    private void renderSlot(int p_194027_, int p_194028_, int p_194029_, boolean p_194030_, Font p_194031_, PoseStack p_194032_, ItemRenderer p_194033_, int p_194034_) {
        if (p_194029_ >= this.items.size()) {
            this.blit(p_194032_, p_194027_, p_194028_, p_194034_, p_194030_ ? ClientQuiverTooltip.Texture.BLOCKED_SLOT : ClientQuiverTooltip.Texture.SLOT);
        } else {
            ItemStack itemstack = this.items.get(p_194029_);
            this.blit(p_194032_, p_194027_, p_194028_, p_194034_, ClientQuiverTooltip.Texture.SLOT);
    ...
    private void drawBorder(int p_194020_, int p_194021_, int p_194022_, int p_194023_, PoseStack p_194024_, int p_194025_) {
        ...
        this.blit(p_194024_, p_194020_, p_194021_ + p_194023_ * 20, p_194025_, ClientQuiverTooltip.Texture.BORDER_CORNER_BOTTOM);
        this.blit(p_194024_, p_194020_ + p_194022_ * 18 + 1, p_194021_ + p_194023_ * 20, p_194025_, ClientQuiverTooltip.Texture.BORDER_CORNER_BOTTOM);
    }
