...
public class QuiverModels {
    ...
    public static ResourceLocation COPPER_QUIVER = new ResourceLocation(NyfsQuiver.MOD_ID,"back/copper_quiver");
    ...
    public static ResourceLocation COPPER_QUIVER_NOARROWS = new ResourceLocation(NyfsQuiver.MOD_ID,"back/copper_quiver_noarrows");
