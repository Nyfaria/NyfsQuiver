...
import com.nyfaria.nyfsquiver.enchantment.Soulbound;
...
//    public static final RegistryObject<Enchantment> SOULBOUND = ENCHANTMENTS.register("soulbound_enchant", () -> new Soulbound(Enchantment.Rarity.VERY_RARE));
